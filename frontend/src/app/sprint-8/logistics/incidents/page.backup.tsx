  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fafafa' }}>
      ...
      <div style={{ 
        ...
        <div style={{
          display: 'grid',
          gridTemplateColumns: '40px 80px 140px 200px 80px 120px 140px 80px 80px 120px 50px',
          gap: '12px',
          padding: '16px',
          background: '#f9fafb',
          ...
          {filteredIncidents.map((incident) => (
            <div
              ...
              style={{
                ...
                fontSize: '14px',
                alignItems: 'center',
                background: incident.isOverdue ? '#fef2f2' : '#fff',
                cursor: 'pointer',
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.background = incident.isOverdue ? '#fef2f2' : '#fff';
              }}
            >
              <input
                type="checkbox"
